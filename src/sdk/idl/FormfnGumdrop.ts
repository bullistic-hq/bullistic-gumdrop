export type BullisticGumdrop = {
  accounts: [
    {
      ...
      type: {
        fields: [
          { docs: ["Account bump."]; name: "bump"; type: "u8" },
          {
    ...
    },
    {
      ...
      type: {
        fields: [
          { docs: ["Bump seed."]; name: "bump"; type: "u8" },
          {
            docs: [
  ...
  errors: [
    ...
    { code: 7005; msg: "Derived key invalid."; name: "DerivedKeyInvalid" },
    {
      code: 7006;
  ...
  instructions: [
    ...
    },
    {
      accounts: [
        ...
        { isMut: true; isSigner: false; name: "distributorWallet" },
        {
        ...
        { isMut: false; isSigner: false; name: "configAuthority" },
        { isMut: false; isSigner: false; name: "systemProgram" }
      ];
      args: [{ name: "walletBump"; type: "u8" }];
      docs: [
    ...
    },
    {
      accounts: [
        ...
        { isMut: false; isSigner: true; name: "configAuthority" },
        { isMut: false; isSigner: true; name: "configCreator" },
    ...
    },
    {
      ...
      args: [{ name: "updatedRoot"; type: { array: ["u8", 32] } }];
      docs: [
